...
class SSFA(nn.Module):
    def __init__(self, model_cfg, input_channels):
        ...
        for i in range(len(layer_strides)):
            ...
            self.bottom_up_block_0.add_module(
                f"conv_{i}",
                nn.Sequential(
                    nn.Conv2d(
        ...
        for i in range(len(seg_layer_strides)):
            ...
            self.bottom_up_block_1.add_module(
                f"conv_{i}",
                nn.Sequential(
                    nn.Conv2d(
                        in_channels=seg_num_filters[i],
                        out_channels=seg_num_filters[i + 1],
                        kernel_size=seg_kernel_sizes[i],
                        padding=padding,
                        stride=seg_layer_strides[i],
                        bias=False,
                    ),
        ...
        for i in range(len(trans_layer_strides)):
            ...
            self.trans.add_module(
                ...
                nn.Sequential(
                    nn.Conv2d(
                        in_channels=trans_num_filters[i],
                        out_channels=trans_num_filters[i + 1],
                        kernel_size=trans_kernel_sizes[i],
                        stride=trans_layer_strides[i],
                        padding=padding,
                        bias=False,
                    ),
        ...
        for i in range(len(deconv_strides_0)):
            ...
            self.deconv_block_0.add_module(
                f"deconv_{i}",
                nn.Sequential(
                    nn.ConvTranspose2d(
                        in_channels=deconv_layer_filters_0[i],
                        out_channels=deconv_layer_filters_0[i + 1],
                        kernel_size=deconv_kernel_sizes_0[i],
                        stride=deconv_strides_0[i],
                        padding=padding,
                        bias=False,
                    ),
        ...
        for i in range(len(deconv_strides_0)):
            ...
            self.deconv_block_1.add_module(
                f"deconv_{i}",
                nn.Sequential(
                    nn.ConvTranspose2d(
                        in_channels=deconv_layer_filters_1[i],
                        out_channels=deconv_layer_filters_1[i + 1],
                        kernel_size=deconv_kernel_sizes_1[i],
                        stride=deconv_strides_1[i],
                        padding=padding,
                        bias=False,
                    ),
        ...
        for i in range(len(conv_0_strides)):
            ...
            self.conv_0.add_module(
                f"conv_{i}",
                nn.Sequential(
                    nn.Conv2d(
                        in_channels=conv_0_layer_filters[0],
                        out_channels=conv_0_layer_filters[i + 1],
                        kernel_size=conv_0_kernel_sizes[i],
                        stride=conv_0_strides[i],
                        padding=padding,
                        bias=False,
                    ),
        ...
        for i in range(len(w_0_strides)):
            ...
            self.w_0.add_module(
                ...
                nn.Sequential(
                    nn.Conv2d(
                        in_channels=w_0_layer_filters[i],
                        out_channels=w_0_layer_filters[i + 1],
                        kernel_size=w_0_kernel_sizes[i],
                        stride=w_0_strides[i],
                        padding=padding,
                        bias=False,
                    ),
        ...
        for i in range(len(conv_1_strides)):
            ...
            self.conv_1.add_module(
                ...
                nn.Sequential(
                    nn.Conv2d(
                        in_channels=conv_1_layer_filters[0],
                        out_channels=conv_1_layer_filters[i + 1],
                        kernel_size=conv_0_kernel_sizes[i],
                        stride=conv_0_strides[i],
                        padding=padding,
                        bias=False,
