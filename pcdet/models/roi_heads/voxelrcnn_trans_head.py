...
class VoxelRCNNHeadTrans(IRoIHead):
    def __init__(
        ...
        attention_combine: bool,
        attention_mask_empty_points: bool,
        ...
        self.attention_mask_empty_points = attention_mask_empty_points
    ...
    def forward(
        ...
        # RoI aware pooling
        pooled_features, local_roi_grid_points = self.roi_grid_pool(
            multiscale_3d_features, rois, batch_size
        )

        src_key_padding_mask = None
        # TODO
        if self.attention_mask_empty_points:
    ...
    def roi_grid_pool(
        ...
        """
        # (BxN, 6x6x6, 3)
        roi_grid_xyz, local_roi_grid_points = _get_global_grid_points_of_roi(
            rois, grid_size=self.pool_grid_size
        )
