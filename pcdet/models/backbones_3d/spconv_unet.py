...
class SparseBasicBlock(spconv.SparseModule):
    ...
    def forward(self, x):
        ...
        out = self.conv1(x)
        out: spconv.SparseConvTensor = out.replace_feature(self.bn1(out.features))
...
class UNetV2(nn.Module):
    ...
    From Points to Parts: 3D Object Detection from Point Cloud
    with Part-aware and Part-aggregation Network
    """
    ...
    def __init__(self, model_cfg, input_channels, grid_size, voxel_size, point_cloud_range):
        ...
        self.conv3 = spconv.SparseSequential(
            ...
            post_act_block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key="subm3"),
            post_act_block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key="subm3"),
        )
        ...
        self.conv4 = spconv.SparseSequential(
            ...
            post_act_block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key="subm4"),
            post_act_block(64, 64, 3, norm_fn=norm_fn, padding=1, indice_key="subm4"),
        )
        ...
        self.conv_up_m4 = post_act_block(128, 64, 3, norm_fn=norm_fn, padding=1, indice_key="subm4")
        self.inv_conv4 = post_act_block(
        ...
        self.conv_up_m3 = post_act_block(128, 64, 3, norm_fn=norm_fn, padding=1, indice_key="subm3")
        self.inv_conv3 = post_act_block(
        ...
        self.conv_up_m2 = post_act_block(64, 32, 3, norm_fn=norm_fn, indice_key="subm2")
        self.inv_conv2 = post_act_block(
        ...
        self.conv_up_m1 = post_act_block(32, 16, 3, norm_fn=norm_fn, indice_key="subm1")
    ...
    def ur_block_forward(self, x_lateral, x_bottom, conv_t, conv_m, conv_inv):
        ...
        x: spconv.SparseConvTensor = x_trans
    ...
    @staticmethod
    def channel_reduction(x: spconv.SparseConvTensor, out_channels):
        """
        Args:
            x: x.features (N, C1)
            out_channels: C2
        ...
        return x.replace_feature(features.view(n, out_channels, -1).sum(dim=2))
