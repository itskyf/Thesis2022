...
int roipool3d_gpu(at::Tensor xyz, at::Tensor boxes3d, at::Tensor pts_feature,
  ...
  roipool3dLauncher(batch_size, pts_num, boxes_num, feature_in_len, sampled_pts_num, xyz_data,
                    boxes3d_data, pts_feature_data, pooled_features_data, pooled_empty_flag_data);
