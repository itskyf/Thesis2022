...
int vector_pool_wrapper_stack(at::Tensor support_xyz_tensor, at::Tensor xyz_batch_cnt_tensor,
                              ...
                              at::Tensor new_local_xyz_tensor, at::Tensor point_cnt_of_grid_tensor,
  ...
  int cum_sum = vector_pool_kernel_launcher_stack(
      ...
      new_xyz_batch_cnt, point_cnt_of_grid, grouped_idxs, num_grid_x, num_grid_y, num_grid_z,
      max_neighbour_distance, batch_size, N, M, num_c_in, num_c_out, num_total_grids, use_xyz,
...
int vector_pool_grad_wrapper_stack(at::Tensor grad_new_features_tensor,
  ...
  // grouped_idxs_tensor: (num_max_sum_points, 3) [idx of support_xyz, idx of new_xyz, idx of
  // grid_idx in new_xyz] grad_support_features_tensor: (N1 + N2 ..., C_in)
  ...
  vector_pool_grad_kernel_launcher_stack(grad_new_features, point_cnt_of_grid, grouped_idxs,
                                         grad_support_features, N, M, num_c_out, num_c_in,
                                         num_total_grids, num_max_sum_points);
  return 1;
}
