...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  m.def("stack_farthest_point_sampling_wrapper", &stack_farthest_point_sampling_wrapper,
  ...
  m.def("three_interpolate_grad_wrapper", &three_interpolate_grad_wrapper_stack,
  ...
  m.def("query_stacked_local_neighbor_idxs_wrapper_stack",
        ...
        "query_stacked_local_neighbor_idxs_wrapper_stack");
  m.def("query_three_nn_by_stacked_local_idxs_wrapper_stack",
  ...
  m.def("vector_pool_grad_wrapper", &vector_pool_grad_wrapper_stack,
