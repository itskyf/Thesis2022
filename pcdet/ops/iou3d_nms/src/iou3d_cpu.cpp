...
inline void rotate_around_center(const Point &center, const float angle_cos, const float angle_sin,
                                 Point &p) {
...
inline float box_overlap(const float *box_a, const float *box_b) {
  ...
  //    float a_x1 = box_a[0], a_y1 = box_a[1], a_x2 = box_a[2], a_y2 = box_a[3], a_angle =
  //    box_a[4]; float b_x1 = box_b[0], b_y1 = box_b[1], b_x2 = box_b[2], b_y2 = box_b[3], b_angle
  //    = box_b[4];
