...
void group_features_grad_kernel_launcher_stack(int B, int M, int C, int N, int nsample,
  ...
  group_features_grad_kernel_stack<<<blocks, threads>>>(
...
__global__ void group_features_kernel_stack(int B, int M, int C, int nsample, const float *features,
...
void group_features_kernel_launcher_stack(int B, int M, int C, int nsample, const float *features,
                                          const int *features_batch_cnt, const int *idx,
                                          const int *idx_batch_cnt, float *out) {
  // :param features: (N1 + N2 ..., C) tensor of features to group
  // :param features_batch_cnt: (batch_size) [N1 + N2 ...] tensor containing the
  ...
  group_features_kernel_stack<<<blocks, threads>>>(B, M, C, nsample, features, features_batch_cnt,
